    ...
    toBeRegularName: function() {
        return {
            compare: function(actual, expected) {
                ...
                result.pass = !actual.match(/[a-zA-Z]/) && !actual.match(/[0-9]/)
...
getStructure(['app-wrap']);


/* Implémentation du test de structure existante */
xdescribe('Applications Modules Order', function() {
    var count = 1;
...
xdescribe('Application Structure :', function() {
